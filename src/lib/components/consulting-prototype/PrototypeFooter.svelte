...
<style>
	...
	.footer-line{max-width:340px;margin:0;color:var(--proto-paper);font:400 19px/1.4 var(--proto-display);letter-spacing:.005em}.footer-line em{color:#8d8571;font-style:italic}
	...
	.footer-bottom{min-height:68px;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;border-top:1px solid var(--proto-line);color:#656c66;font:9px var(--proto-mono);letter-spacing:.08em;text-transform:uppercase}.footer-bottom b{font-weight:500;color:#9c8a68}.footer-bottom a{justify-self:end;color:#747b75;text-decoration:none;transition:color .2s ease}
	@media(max-width:760px){.site-footer{padding:0 20px}.footer-main{padding:52px 0;grid-template-columns:1fr 1fr;gap:45px 30px}.footer-lead{grid-column:1/-1}.footer-line{font-size:16px}.footer-contact span{max-width:240px}.footer-bottom{min-height:105px;grid-template-columns:1fr auto;gap:12px}.footer-bottom b{display:none}.footer-bottom a{justify-self:end}}
</style>
