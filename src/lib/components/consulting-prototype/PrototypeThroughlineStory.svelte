...
<style>
	...
	@keyframes blink{50%{opacity:0}}@keyframes click-pulse{0%{opacity:0;transform:scale(.85)}45%{opacity:1;transform:scale(1)}100%{opacity:0;transform:scale(1.08)}}@keyframes refresh-pulse{50%{transform:rotate(180deg);color:#4eaa81}}
	...
	.story{
		...
		background:
			...
			radial-gradient(circle at 88% 23%,rgba(105,73,128,.14),transparent 22%),
	...
	.color-field{position:absolute;inset:0;pointer-events:none;overflow:hidden}.color-field i{position:absolute;border-radius:50%;opacity:.16}.color-field i:first-child{width:470px;height:470px;left:-195px;top:195px;background:radial-gradient(circle closest-side,#0e8e66,transparent)}.color-field i:nth-child(2){width:380px;height:380px;right:1%;top:330px;background:radial-gradient(circle closest-side,#6d4bb1,transparent)}.color-field i:last-child{width:310px;height:310px;right:25%;top:130px;background:radial-gradient(circle closest-side,#c8784f,transparent);opacity:.08}
	...
	.story-caption{position:relative;z-index:3;width:min(1240px,92%);margin:0 auto 20px;display:grid;grid-template-columns:1fr 1.1fr auto;gap:28px;align-items:center;color:var(--proto-muted);font:500 7px var(--proto-mono);letter-spacing:.09em}.story-caption>span{color:#8c948e}.story-caption p{margin:0;font:400 11px/1.55 var(--proto-sans);letter-spacing:0}.story-caption button{padding:0;border:0;color:#b9beb9;background:none;font:500 7px var(--proto-mono);letter-spacing:.09em;cursor:pointer}.story-caption button i{display:inline-block;width:13px;height:13px;margin-right:7px;border:1px solid #3b5d4e;border-radius:50%;vertical-align:-3px;position:relative}.story-caption button i::after{content:'';position:absolute;left:4px;top:3px;width:3px;height:5px;border-right:1px solid #77aa91;transform:rotate(-35deg)}
	...
	.browser{left:2.4%;right:2.4%;top:56px;bottom:101px;border-color:rgba(255,255,255,.16);background:#101411;box-shadow:0 22px 65px rgba(0,0,0,.46),0 0 0 1px rgba(255,255,255,.025) inset}.tab-strip{background:linear-gradient(180deg,#181d19,#111512)}.browser-tab{border-top:1px solid rgba(255,255,255,.035);background:#1a201b}.browser-tab.active{background:#2b332d;color:#edf0ea;box-shadow:0 -1px 0 rgba(69,167,127,.3) inset}.tool-tab{background:color-mix(in srgb,var(--brand-color) 9%,#191e1a);border-top-color:color-mix(in srgb,var(--brand-color) 35%,transparent)}.brand-icon{color:var(--brand-color,#dedfda);filter:drop-shadow(0 0 7px color-mix(in srgb,var(--brand-color) 28%,transparent))}.brand-icon img{filter:saturate(1.12)}.notion-tab .brand-icon{color:#f4f4f4}.address-row{background:linear-gradient(180deg,#2b322d,#242a26)}.address-row>div{border:1px solid rgba(255,255,255,.035);box-shadow:0 1px 0 rgba(255,255,255,.025)}
	.business-page{background:linear-gradient(125deg,#e8e1d5 0%,#d9d6cc 58%,#cec7bb 100%)}.business-page::before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 83% 18%,rgba(7,84,63,.21),transparent 30%),linear-gradient(90deg,transparent 49.8%,rgba(7,84,63,.07) 50%,transparent 50.2%);pointer-events:none}.business-page nav{position:relative;z-index:2;background:rgba(232,225,213,.92)}.business-page nav button{background:linear-gradient(135deg,#07543f,#0d7256);box-shadow:0 8px 24px rgba(7,84,63,.16)}.site-visual{overflow:hidden;background:linear-gradient(145deg,rgba(7,84,63,.29),rgba(180,154,103,.16));box-shadow:0 22px 60px rgba(7,84,63,.12)}.site-visual::after{content:'';position:absolute;inset:-50%;background:linear-gradient(105deg,transparent 42%,rgba(255,255,255,.26) 50%,transparent 58%);transform:translateX(-55%);animation:site-sheen 5s ease-in-out infinite}.error-page{background:radial-gradient(circle at 50% 36%,rgba(122,52,42,.24),transparent 31%),linear-gradient(180deg,#160e0c,#0b0d0c 65%)}.error-page strong{text-shadow:0 12px 55px rgba(171,76,54,.14)}.search-page{background:radial-gradient(circle at 50% 38%,#fff 0%,#f1eee8 52%,#d9d7d0 100%)}.consulting-page{background:radial-gradient(circle at 82% 24%,rgba(16,116,83,.72),transparent 40%),radial-gradient(circle at 14% 86%,rgba(111,73,128,.18),transparent 32%),#080b09}.notion-pane{background:linear-gradient(160deg,#1e211f,#141715)}.task.complete>i{box-shadow:0 0 16px rgba(78,170,129,.25)}
	@keyframes site-sheen{0%,48%{transform:translateX(-55%)}72%,100%{transform:translateX(55%)}}
	.business-page.hidden .site-visual::after{animation-play-state:paused}
	...
	.monitor::before{
		...
		border-radius:45%;
		background:radial-gradient(ellipse at 50% 48%,rgba(25,103,76,.22),rgba(74,52,105,.08) 44%,transparent 72%);
		filter:blur(12px);
		pointer-events:none;
	}
	...
	.story-progress>i>b{display:block;width:100%;height:100%;background:linear-gradient(90deg,#267d5e,#5bc296);transform-origin:left}
	...
	@media(max-width:620px){
		...
		.monitor{width:100%}
		.screen-frame{aspect-ratio:16/10;border-radius:7px}
