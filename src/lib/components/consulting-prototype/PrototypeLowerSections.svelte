...
{#if showWork}
	<section class="work-showcase shell" id="work" data-motion-section>
		<header class="section-heading">
			<div><p class="eyebrow" data-motion-item>{consultingSite.workPreview.eyebrow}</p><h2 data-motion-item>{consultingSite.workPreview.title}</h2><a class="text-button" data-motion-item href="/consulting/work">{consultingSite.workPreview.cta}</a></div>
		</header>
...
<style>
	...
	.cta-copy h2 em{font-weight:400;font-style:normal;color:var(--proto-paper)}
	.cta-copy>p:not(.eyebrow){max-width:560px;margin:31px 0 0;color:#b4bcb5;font-size:16.5px;line-height:1.7}
