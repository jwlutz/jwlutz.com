		...
		<div class="project-stage" aria-label="Selected Lutz Consulting Group work" data-motion-item>
			...
			<div class="project-grid">
				{#each projects as project, index}
					<a class={`work-project-card project-${index + 1}`} href={project.url} target="_blank" rel="noreferrer" aria-label={`Visit ${project.name}`} onclick={() => trackOutbound(project.url, 'proto_work_showcase')}>
