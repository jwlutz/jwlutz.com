...
<style>
	...
	.case-heading > div { display: flex; justify-content: space-between; align-items: baseline; font: 500 9px var(--proto-mono); letter-spacing: .12em; color: var(--proto-green-light); }
	...
	.evidence-grid span { display: block; margin-top: 8px; font: 500 7px/1.45 var(--proto-mono); letter-spacing: .08em; color: var(--proto-muted); }
	...
	.case-copy::before { content: ''; position: absolute; left: -1px; top: 0; width: 2px; height: 118px; background: var(--proto-green); }
	.case-kicker { font: 500 9px var(--proto-mono); letter-spacing: .12em; color: var(--proto-green-light); margin: 0 0 22px; }
	...
	.live-link small{font:500 8px var(--proto-mono);letter-spacing:.04em;opacity:.58}
	...
	.narrative section > p, .responsibilities > p { margin: 0; font: 500 9px var(--proto-mono); letter-spacing: .1em; text-transform: uppercase; color: var(--proto-green-light); }
	...
	.thread-tick { height: 1px; width: 20px; margin-top: 7px; background: var(--proto-green); }
	...
	.responsibilities li::before { content: '—'; margin-right: 10px; color: var(--proto-green-light); }
