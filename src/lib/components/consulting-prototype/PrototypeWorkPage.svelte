...
<div class="work-prototype" id="top">
	...
	<main>
		...
		<section class="work-cta" id="contact">
			...
			<a href={email} onclick={() => track('email_click', { source: 'consulting_prototype', location: 'work_index_cta' })}>Start a project <small>{consultingSite.contactEmail}</small></a>
		</section>
	</main>
