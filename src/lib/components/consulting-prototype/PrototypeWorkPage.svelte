...
<style>
	/* Same metric-matched fallback as PrototypeLanding (see note there). */
	@font-face {
	...
	.work-prototype{--proto-bg:#080b09;--proto-surface:#131815;--proto-surface-2:#19201b;--proto-green:#07543f;--proto-green-light:#2d8064;--proto-green-deep:#0d2d24;--proto-text:#f0efe9;--proto-muted:#adafaa;--proto-paper:#dad6cc;--proto-brass:#b49a67;--proto-line:rgba(240,239,233,.1);--proto-line-strong:rgba(240,239,233,.18);--proto-display:'Instrument Serif','Instrument Serif Fallback',Georgia,serif;--proto-sans:'DM Sans',sans-serif;--proto-mono:'IBM Plex Mono',monospace;background:var(--proto-bg);color:var(--proto-text);font-family:var(--proto-sans);min-height:100vh;overflow:clip}
	...
	@media(max-width:980px){.case-visual :global(.case-artifact){height:auto;min-height:0;aspect-ratio:16/10}}
